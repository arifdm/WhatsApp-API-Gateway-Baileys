  ...
  return (
    <div className="w-full md:w-1/3">
      <div className="bg-white rounded-xl shadow-md p-6 sticky top-4">
        <h1 className="text-xl font-bold mb-6 text-gray-800">Scan QR Code</h1>
        {!sessionId ? (
          <p className="text-gray-500 text-sm">
            Silakan pilih device di daftar terlebih dahulu...!
          </p>
        ) : (
          <div className="space-y-4">
            <div>
              <h2 className="text-sm font-medium text-gray-500 mb-1">Device</h2>
